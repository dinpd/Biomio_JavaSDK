...
import biomio.sdk.internal.state.implementation.StateConnected;
import biomio.sdk.internal.state.implementation.StateDisconnected;
import biomio.sdk.internal.state.implementation.StateReady;
import biomio.sdk.internal.state.istate.IState;
...
public class StateMachine {
    ...
    /**
     * Registers current biomio.sdk.internal.state.
     *
    ...
    /**
     * This method is invoked in response callback of socket in order to switch the biomio.sdk.internal.state,
    ...
    /**
     * If biomio.sdk.internal.state is {@link IStateReady} - sends ping message to server
